...
const SkillsList = () => {
  ...
  const skills = {
    Frontend: [
      "I design modern, optimized front ends with a focus on exceptional user experience—crafting SPAs, static sites, and SSR apps alike.",
    ],
    Backend: [
      "I create robust, secure, and performant backends, whether deploying on established platforms or crafting custom solutions.",
    ],
    "Product Engineering": [
      "I contribute to product success by leading ideation and iterative development as a dedicated product engineer.",
    ],
  };
